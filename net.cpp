...
////////////////////////////////////////////////////////////////////////////////
netAddress::netAddress(const token& host, uint16 port, bool portoverride)
{
...
////////////////////////////////////////////////////////////////////////////////
void netAddress::set(uint addr, uint16 port)
{
...
////////////////////////////////////////////////////////////////////////////////
void netAddress::set(const token& host, uint16 port, bool portoverride)
{
    memset(this, 0, sizeof(netAddress));
    ...
    */
    ...
    else
    {
        ...
        if (nameport.first_char() == ':') {
            ++nameport;
            p = (uint16)nameport.touint_and_shift();
...
////////////////////////////////////////////////////////////////////////////////
void netAddress::setPort(uint16 port)
{
    sin_port = htons(port);
}
...
{
    if (handle == UMAXS)
        throw ersDISCONNECTED;  //invalid handle
...
////////////////////////////////////////////////////////////////////////////////
int netSocket::bind(const char* host, uint16 port)
{
    if (handle == UMAXS)
        throw ersDISCONNECTED;  //invalid handle
...
////////////////////////////////////////////////////////////////////////////////
int netSocket::connect(const token& host, uint16 port, bool portoverride)
{
    if (handle == UMAXS)
        throw ersDISCONNECTED;  //invalid handle
